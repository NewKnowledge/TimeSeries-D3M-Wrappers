...
git branch hdbscan_pipelines
git checkout hdbscan_pipelines
...
for i in "${Datasets[@]}"; do
  ...
  # generate and save pipeline + metafile
  python3 "/src/timeseriesd3mwrappers/TimeSeriesD3MWrappers/pipelines/Hdbscan_pipeline_unsupervised.py" $i
