...
cd /primitives/v2019.6.7/Distil/d3m.primitives.time_series_classification.shapelet_learning.Shallot/1.0.2/pipelines
mkdir test_pipeline
cd test_pipeline
...
for i in "${Datasets[@]}"; do
  ...
  python3 "/src/timeseriesd3mwrappers/TimeSeriesD3MWrappers/pipelines/Shallot_pipeline_$i.py" $i
