...
step_2.add_hyperparameter(name='filter_index', argument_type= ArgumentType.VALUE, data=1)
step_2.add_hyperparameter(name='datetime_filter', argument_type= ArgumentType.VALUE, data=2)
