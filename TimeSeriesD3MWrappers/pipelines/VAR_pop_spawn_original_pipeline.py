...
step_3 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.time_series_forecasting.vector_autoregression.VAR'))
step_3.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.2.produce')
step_3.add_argument(name='outputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.2.produce')
step_3.add_hyperparameter(name='filter_index_one', argument_type= ArgumentType.VALUE, data=2)
step_3.add_hyperparameter(name='filter_index_two', argument_type= ArgumentType.VALUE, data=1)
step_3.add_hyperparameter(name='n_periods', argument_type= ArgumentType.VALUE, data=58)
step_3.add_hyperparameter(name='specific_intervals', argument_type= ArgumentType.VALUE, 
...
step_3.add_hyperparameter(name='datetime_index_unit', argument_type= ArgumentType.VALUE, data='D')
