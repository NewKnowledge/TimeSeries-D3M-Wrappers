...
# Step 4: extract targets for Distil ensemble classifier
...
step_4.add_hyperparameter(name='semantic_types', argument_type=ArgumentType.VALUE,data=('https://metadata.datadrivendiscovery.org/types/Target', 'https://metadata.datadrivendiscovery.org/types/TrueTarget', 'https://metadata.datadrivendiscovery.org/types/SuggestedTarget'))
pipeline_description.add_step(step_4)

# Step 5: extract targets for Distil ensemble classifier
