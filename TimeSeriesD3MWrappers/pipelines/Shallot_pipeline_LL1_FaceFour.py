...
step_1 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.time_series_classification.shapelet_learning.Shallot'))
step_1.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.0.produce')
step_1.add_argument(name='outputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.0.produce')
step_1.add_hyperparameter(name='epochs', argument_type= ArgumentType.VALUE, data=5000)
step_1.add_hyperparameter(name='weight_regularizer', argument_type= ArgumentType.VALUE, data=1)
step_1.add_hyperparameter(name='num_shapelets', argument_type= ArgumentType.VALUE, data=.3)
step_1.add_hyperparameter(name='min_shapelet_length', argument_type= ArgumentType.VALUE, data=.175)
