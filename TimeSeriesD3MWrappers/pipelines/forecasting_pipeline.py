...
step_3 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.data_transformation.grouping_field_compose.Common'))
...
step_5 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.time_series_forecasting.convolutional_neural_net.DeepAR'))
